...
export default {
  ...
  async render(container, db, params) {
    ...
    container.innerHTML = `
            <div class="card mb-lg">
                ...
                <div style="display: flex; gap: var(--space-md); align-items: center; flex-wrap: wrap;">
                    ...
                    <input type="text"
                           ...
                           class="search-input"
                           style="flex: 1; min-width: 200px; padding: var(--space-md); border: 2px solid var(--color-accent); border-radius: var(--border-radius-sm); font-size: var(--font-size-lg);">
            ...
            <div id="search-empty" class="card" style="text-align: center; padding: var(--space-xl);">
                <h3 style="margin-bottom: var(--space-md);">Explore Topics</h3>
                <p style="color: var(--color-text-muted); margin-bottom: var(--space-lg);">Click any word to search</p>
                <div id="word-cloud" class="word-cloud"></div>
            </div>
            
            <div id="search-no-results" class="card" style="text-align: center; padding: var(--space-2xl); display: none;">
  ...
  performSearch(term) {
    ...
    tbody.innerHTML = results.map(result => `
            <tr class="clickable" 
                ...
                <td style="max-width: 300px; font-size: var(--font-size-sm); color: var(--color-text-muted);">
